...
import dentist from "../../images/patientinformation.png";
          ...
          <nav className="nav-container flex justify-left text-xl md:text-3xl">
            <div className="nav-column mr-8">
              <ul className="space-y-1">
                ...
                <li>
                  <a href="/patientinformation/patienteducation" className="underline md:no-underline hover:underline transition duration-300">
                    Patient Education
                  </a>
                </li>
