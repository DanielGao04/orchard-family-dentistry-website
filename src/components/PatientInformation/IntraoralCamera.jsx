    ...
    <div className="bg-cover">
      ...
      <div className="px-16 md:px-48 py-16 mx-24">
        ...
        <section className="mb-16">
          <h1 className="text-6xl font-semibold text-left text-blue-900 font-Poppins">
          Intraoral Camera
          </h1>
          <p className="mt-4 text-2xl text-left text-blue-900 font-Poppins">
          Before you start imagining the dentist trying to put something the size of a point-&-shoot camera in your mouth, you should know that intraoral cameras are very small. In fact, they’re only about the size of an extra thick marker.          </p>
          <p className="mt-4 text-2xl text-left text-blue-900 font-Poppins">
        ...
        <section className="mb-16 border py-10 px-10 bg-cover bg-blue-100">
          <h2 className="text-5xl font-semibold text-left text-blue-900 font-Poppins">
