  ...
  return (
    ...
    <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-10/12 sm:pr-16">
                <h3 class="mt-2 text-3xl sm:text-left md:text-5xl">Four types of impacted wisdom teeth</h3>
                <p class="mt-5 text-2xl text-gray-700 text md:text-left">When there isn’t enough room in the back of the mouth, wisdom teeth may not be able to erupt or emerge, and they become impacted. There are four types of impacted wisdom teeth</p>
            </div>
        </div>
        ...
        <div className="flex bg-cover  transform transition-transform duration-1500 justify-center py-10">
          ...
          <h1 className="my-5 text-5xl text-blue-900 font-semibold text-leftpb-1">
